...
function Card({title, description, imgURL, children}){
    ...
    const cambiaSfondo = () =>{
      setIsSpotted (prev => !prev)
    }
    return(
<div className="card" style={{ backgroundColor: isSpotted ? "lightgreen" : "lightcoral" }}>
              <div className="card-img">
          ...
          <button onClick={cambiaSfondo} >{isSpotted ? "avvistato" : "non avvistato"}
          </button>
